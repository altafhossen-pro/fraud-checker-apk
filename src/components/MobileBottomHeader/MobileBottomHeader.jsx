...
const MobileBottomHeader = ({ onLogout }) => {
    ...
    return (
        <div>
            <footer className="lg:hidden fixed z-[99999] bottom-0 bg-customBlue flex items-center justify-between w-full h-16 px-3 sm:px-10 ">
                <button
                    ...
                    <div className="drawer-content">
                        <div className="flex flex-col w-full h-full bg-white dark:text-slate-400 dark:bg-slate-800 cursor-pointer scrollbar-hide">
                            ...
                            <div className="w-full max-h-full">
                                ...
                                <div className='px-4'>
                                    <div className='my-3'>
                                        <Link lang='bn' className='mb-8' to='/'>
                                            ওয়েবসাইট লিংক
                                        </Link>
                                    </div>
                                    ...
                                    <div className='mb-3' >
                                        <Link lang='bn' to='/'>
                                            ওয়ার্ডপ্রেস প্লাগিন ডাউনলোড করুন
                                        </Link>
                                    </div>
                                </div>
                                <h2 lang='bn' className="font-semibold font-serif text-lg m-0 text-heading flex align-center justify-center text-center border-b px-4 py-3">
                                    ভিডিও টিউটোরিয়াল
                                </h2>
                                <div className='px-4'>
                                    <div className='my-3'>
                                        <Link lang='bn' className='mb-8' to='/'>
                                            এন্ড্রয়েড এপস সেটাপ ভিডিও লিংক
                                        </Link>
                                    </div>
                                    ...
                                    <div className='mb-3' >
                                        <Link lang='bn' to='/'>
                                            ওয়ার্ডপ্রেস প্লাগিন সেটাপ ভিডিও লিংক
                                        </Link>
                                    </div>
                                    <div className='mb-3' >
                                        <Link lang='bn' to='/'>
                                            সাবস্ক্রিপশন আপগ্রেড ভিডিও লিংক
                                        </Link>
                                    </div>
                                    <div className='mb-3' >
                                        <Link lang='bn' to='/'>
                                            এপিআই কি (API Key) দেখার ভিডিও লিংক
                                        </Link>
                                    </div>
                                    <div className='mb-3' >
                                        <Link lang='bn' to='/'>
                                            ওয়েবসাইট ব্যাবহার করে চেক করার ভিডিও লিংক
                                        </Link>
                                    </div>
                                </div>
